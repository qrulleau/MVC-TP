...
require_once __DIR__ . '/../../components/header.php' ?>
  ...
  <form class="py-12" method="post">   
    ...
    <div class="relative">
        ...
        <input type="title_search" name="title_search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Recherche ton film prefere" required>
    ...
    <div class="flex flex-wrap listing">
      <?php
      ...
      <div class="box">
        ...
        <div class="description d-flex direction-column align-start">
          ...
          <div class="d-flex">
            <a class="more" href="<?php echo 'http://www.localhost/MVC-TP/index.php?route=detail&id=' . $movie['id_movie'] ?>">
            <div class="d-flex">
                  En savoir plus
            ...
            <div class="d-flex">
              <a href="<?php echo 'http://www.localhost/MVC-TP/index.php?route=update&id=' . $movie['id_movie'] ?>">
              ...
              <a href="<?php echo 'http://www.localhost/MVC-TP/index.php?route=delete&id=' . $movie['id_movie'] ?>">
                <svg width="32px" height="32px" viewBox="0 0 24 24" fill="red" xmlns="http://www.w3.org/2000/svg">
